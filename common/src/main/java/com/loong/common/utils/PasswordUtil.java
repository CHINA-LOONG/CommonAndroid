...
import com.loong.common.utils.Base64;
...
public class PasswordUtil {
    ...
    public static final String Salt = "5oTUiPqD";//密钥
    ...
    public static String encrypt2(String sSrc, String sKey) throws Exception {
        ...
        String result = com.loong.common.utils.Base64.getEncoder().encodeToString(encrypted);
