package com.loong.common.view.indexbar;
...
public class SideIndexBar extends View {
    private static final String[] DEFAULT_INDEX_ITEMS = {"群主", "*", "A", "B", "C", "D", "E", "F", "G", "H",
    ...
    private int mTextColor = 0xDD333333;
    private int mTextTouchedColor = 0xDD333333;
    ...
    public SideIndexBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mTextSize = typedArray.getDimensionPixelSize(R.styleable.SideIndexBar_textSize, mTextSize);
            mTextColor = typedArray.getColor(R.styleable.SideIndexBar_textColor, mTextColor);
            mTextTouchedColor = typedArray.getColor(R.styleable.SideIndexBar_touchedColor, mTextTouchedColor);
            typedArray.recycle();
        }
        // https://developer.android.google.cn/reference/android/graphics/Paint
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);  // 开启抗锯齿绘制
    ...
    public SideIndexBar setNavigationBarHeight(int height) {
